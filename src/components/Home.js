  ...
  render() {
    return (
      <MainContent>
        ...
        <a className="homeLinks" href="http://github.com/laere/diversion-2">Click here</a><span>to see the projects source code.</span> <a className="homeLinks" href="https://twitter.com/zack_bostian">And here</a><span>to follow me on twitter!</span>
        </div>
      </MainContent>
    );
  }
